...
![Java基础全程脉络图](./../../.vuepress/public/assets/images/java/java_overview.assets/Java基础全程脉络图.png)

### 1.2 本章专题与脉络

![第1阶段：Java基本语法-第01章](./../../.vuepress/public/assets/images/java/java_overview.assets/第1阶段：Java基本语法-第01章.png)
...
- `麦可思研究院`发布了《**2022年中国大学生就业报告**》，针对2021届毕业生收入较高的本科专业排行榜：
  ...
  <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/就业报告.jpeg" alt="img" style="zoom: 50%;" />

- `麦可思研究院`发布过《**2021年中国大学生就业报告**》，应届本科毕业生就业数量较大的前十位行业类的就业质量：

  <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/jiuyezhiliang1.jpg" alt="jiuyezhiliang1" style="zoom: 67%;" />

- 报告还对毕业三年后的2017届毕业生所在十大行业进行了统计：

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/jiuyezhiliang2.jpg" alt="jiuyezhiliang2" style="zoom: 60%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220523002428542.png" alt="image-20220523002428542" style="zoom:80%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220522234544537.png" alt="image-20220522234544537" style="zoom: 80%;" />
...
![image-20220504101615999](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220504101615999.png)

![image-20220608160444947](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220608160444947.png)

- **移动应用领域（集成Android平台）**：Java在Android端是主要开发的语言，占有重要的地位。

  <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220511092649122.png" alt="image-20220511092649122" style="zoom: 65%;" />

  <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/20220608_160310.jpg" alt="20220608_160310" style="zoom:67%;" />

- **企业级应用领域（JavaEE后台）**：用来开发企业级的应用程序，大型网站如淘宝、京东、12306，以及各大物流、银行、金融、社交、医疗、交通、各种OA系统等都是用JavaEE技术开发的。

  <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220511090528043.png" alt="image-20220511090528043" style="zoom:67%;" />

- **大数据分析、人工智能领域**：流行的大数据框架，如Hadoop、Flink都是用Java编写的。Spark使用Scala编写，但可以用Java开发应用。

  <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220511091647358.png" alt="image-20220511091647358" style="zoom:70%;" />

  ![image-20220513233529610](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220513233529610.png)
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220602105134523.png" alt="image-20220602105134523" style="zoom:80%;" />

还可以是：

![image-20220602105213557](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220602105213557.png)
...
![技术发展路线](./../../.vuepress/public/assets/images/java/java_overview.assets/技术发展路线.jpg)
...
![image-20220524152902812](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220524152902812.png)
...
![image-20220731234604511](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220731234604511.png)

### 3.3 输入设备：键盘输入

- 熟悉指法

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220517100223784.png" alt="image-20220517100223784" style="zoom: 80%;" />

不熟悉键盘的小伙伴，可以“`金山打字通`”走起了。坚决杜绝`二指禅`！！

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220517100543176.png" alt="image-20220517100543176" style="zoom:67%;" />
...
![image-20220522215226273](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220522215226273.png)

应用软件：

![macdesk](./../../.vuepress/public/assets/images/java/java_overview.assets/macdesk.png)
...
- **命令行方式**（Command Line Interface，CLI），需要在控制台输入特定的`指令`，让计算机完成一些操作。需要记忆一些指令，较为麻烦。
  ...
  <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/u=2668016850,3232153547&fm=253&fmt=auto&app=138&f=JPEG" alt="img" style="zoom:67%;" />
...
- 按下Windows+R键盘，打开运行窗口，输入cmd回车，进入到DOS的操作窗口。
  ...
  <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220520100110104.png" alt="image-20220520100110104" style="zoom:80%;" />
...
* **第一代：机器语言（相当于人类的石器时代）**
  ...
  * 这种语言本质上是计算机能识别的唯一语言，人类很难理解。可以大胆想象"`此时的程序员99.9%都是异类！`"
    ...
    ![image-20220309223406537](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220309223406537.png)
...
* **第二代：汇编语言（相当于人类的青铜&铁器时代）**
  ...
  * 缺点：汇编语言是`面向机器的`，不同计算机机型特点不同，因此会有不同的汇编语言，彼此之间`不能通用`。程序不易移植，较难调试。
    ...
    <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220309223725671.png" alt="image-20220309223725671" style="zoom:67%;" />
...
* **第三代：高级语言（相当于人类的信息时代）**
  ...
  * 高级语言发展于20世纪50年代中叶到70年代，是一种`接近于人们使用习惯`的程序设计语言。它允许程序员使用`接近日常英语`的指令来编写程序，程序中的符号和算式也与`日常用的数学式子`差不多，接近于自然语言和数学语言，容易为人们掌握。比如：
    ...
    ![image-20211218092541175](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20211218092541175.png)

  * 高级语言`独立于机器`，有一定的通用性；计算机不能直接识别和执行用高级语言编写的程序，需要使用编译器或者解释器，`转换为机器语言`才能被识别和执行。

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20211218092630678.png" alt="image-20211218092630678" style="zoom:80%;" />

![image-20211218092541075](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20211218092541075.png)
...
![image-20221027112824724](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20221027112824724.png)

计算机语言走势

![image-20221027113511832](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20221027113511832.png)

### 5.4 编程语言，该学哪个？

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310151657860.png" alt="image-20220310151657860" style="zoom: 50%;" />

网传的编程语言鄙视链：

![image-20220310151750665](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310151750665.png)
...
![image-20220309230839100](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220309230839100.png)
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310152923961.png" alt="image-20220310152923961" style="zoom:67%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220309230923533.png" alt="image-20220309230923533" style="zoom: 67%;" />
...
![image-20221027145908490](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20221027145908490.png)
...
![image-20211218093009884](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20211218093009884.png)
...
![](./../../.vuepress/public/assets/images/java/java_overview.assets/JDKJRE.jpg)

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310200731185.png" alt="image-20220310200731185" style="zoom:67%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20221108221057540.png" alt="image-20221108221057540" style="zoom:80%;" />

***

![image-20220310201541841](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310201541841.png)
...
![d315](./../../.vuepress/public/assets/images/java/java_overview.assets/d315.jpeg)
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220428151952049.png" alt="image-20220428151952049" style="zoom: 67%;" />
...
![image-20220527155439683](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220527155439683.png)
...
![1572254490435](./../../.vuepress/public/assets/images/java/java_overview.assets/下载1.png)

（1）在Developers页面中间的技术分类部分，选择`Java`，单击进入，如图所示：

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20211019110551338.png" alt="image-20211019110551338" style="zoom: 50%;" />

（2）这里展示的是最新Java版本，例如Java17。单击`Download Java`，然后选择具体的版本下载。

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20211019110843394.png" alt="image-20211019110843394" style="zoom:80%;" />

（3）选择Download Java按钮后

![image-20211019111110242](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20211019111110242.png)

（4）如果想安装Java8 可以选择如下位置：

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20211019111150970.png" alt="image-20211019111150970" style="zoom:80%;" />

（5）选择Accept License Agreement，

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20211019111252989.png" alt="image-20211019111252989" style="zoom:80%;" />

（6）注册或登录后下载：

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20211019111922387.png" alt="image-20211019111922387" style="zoom:50%;" />

（7）如果需要安装其它版本，可以选择Java archive：

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220801004606762.png" alt="image-20220801004606762" style="zoom: 67%;" />

接着进行选择下载即可：

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220801004648997.png" alt="image-20220801004648997" style="zoom:67%;" />
...
![image-20220303083718546](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220303083718546.png)

（2）修改安装路径，单击更改，如图所示：

![image-20220303083759546](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220303083759546.png)

（3）将安装路径修改为`D:\develop_tools\jdk\jdk-17.0.2\`，并单击下一步，如图所示：

![image-20220303083845794](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220303083845794.png)

（4）稍后几秒，安装完成，如图所示：

![image-20220303083905277](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220303083905277.png)

![image-20220303083931309](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220303083931309.png)
...
![image-20220310223852720](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310223852720.png)

我们在JDK的安装目录的bin目录下使用javac命令，结果如下：

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220607113708022.png" alt="image-20220607113708022" style="zoom:75%;" />
...
![image-20220310224844837](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310224844837.png)

（2）选择`高级系统设置`，如图所示：

![image-20220310224912273](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310224912273.png)

（3）在`高级`选项卡，单击`环境变量`，如图所示：

![image-20220310224952745](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310224952745.png)

（4）在`系统变量`中，选中`Path` 环境变量，`双击`或者`点击编辑` ,如图所示：

![image-20220310225023208](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310225023208.png)

（5）点击`新建`，填入`D:\develop_tools\jdk\jdk1.8.0_271\bin`  ，并将此值`上移`到变量列表的首位。如图所示：

- 编辑模式1：

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220607114102135.png" alt="image-20220607114102135" style="zoom:80%;" />

- 编辑模式2：（注意，结尾需要有英文模式下的;）

![image-20220929104547925](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220929104547925.png)

（6）环境变量配置完成，**重新开启**DOS命令行，在任意目录下输入`javac` 或`java`命令或`java -version`，运行成功。

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220607114432286.png" alt="image-20220607114432286" style="zoom:80%;" />

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220607114517652.png" alt="image-20220607114517652" style="zoom:90%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310225245208.png" alt="image-20220310225245208" style="zoom:90%;" />

（5）变量名输入`JAVA_HOME`，变量值输入 `D:\develop_tools\jdk\jdk1.8.0_271` ，单击`确定`，如图所示：

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220607114800372.png" alt="image-20220607114800372" style="zoom:80%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220607114953758.png" alt="image-20220607114953758" style="zoom:80%;" />
...
![image-20220607115255562](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220607115255562.png)

#### 7.5.4 JDK17配置方案：自动配置

不管大家有没有提前安装JDK8或其它版本JDK，在我们安装完JDK17之后，理应按JDK8的方式配置path环境变量。但是，我们发现在安装完JDK17以后，配置环境变量之前，执行CMD指令：

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220607115700870.png" alt="image-20220607115700870" style="zoom:80%;" />

竟然成功了！而且是17.0.2版本。因为JDK17在安装之后，自动进行了环境变量的配置。如下：

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220607115840388.png" alt="image-20220607115840388" style="zoom:80%;" />

这里建议，将JDK17安装的路径，设置为JAVA_HOME，并将`%JAVA_HOME%\bin`上移到首位。

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20221110142710972.png" alt="image-20221110142710972" style="zoom:80%;" />

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20221110142734279.png" alt="image-20221110142734279" style="zoom:80%;" />
...
![image-20220310230210728](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310230210728.png)

### 8.2 编写

（1）在`D:\JavaSE\chapter01` 目录下新建文本文件，完整的文件名修改为`HelloWorld.java`，其中文件名为`HelloWorld`，后缀名必须为`.java`。

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220801010222222.png" alt="image-20220801010222222" style="zoom:90%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310230618659.png" alt="image-20220310230618659" style="zoom:67%;" />

或

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220521173215013.png" alt="image-20220521173215013" style="zoom:90%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220801010435144.png" alt="image-20220801010435144" style="zoom:80%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220801010840640.png" alt="image-20220801010840640" style="zoom:80%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220801011104381.png" alt="image-20220801011104381" style="zoom:80%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220513185907022.png" alt="image-20220513185907022" style="zoom:50%;" />

- 级别二：集成开发环境（Integrated Development Environment，IDE）

> 把代码编写，编译，执行，调试等多种功能综合到一起的开发工具。

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220513190655773.png" alt="image-20220513190655773" style="zoom:50%;" />
...
举例1：
 ...
 <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310231657692.png" alt="image-20220310231657692" style="zoom:80%;" />
...
举例2：
 ...
 <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310231717893.png" alt="image-20220310231717893" style="zoom:80%;" />
...
举例1：
 ...
 <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310231746581.png" alt="image-20220310231746581" style="zoom:90%;" />

声明为public的类应与文件名一致，否知编译失败。

举例2：

 <img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310231815405.png" alt="image-20220310231815405" style="zoom:80%;" />
...
当cmd命令行窗口的字符编码与.java源文件的字符编码不一致，如何解决？
 ...
 ![1557881223916](./../../.vuepress/public/assets/images/java/java_overview.assets/命令行编译乱码.png)

解决方案一：

- 在Notepad++等编辑器中，修改源文件的字符编码：

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/Notepad修改源文件字符编码.png" alt="1557881271819" style="zoom:80%;" />

- 在EditPlus中可以将Java源文件另存为ANSI编码方式（中文操作系统下即为GBK字符集）

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/1658810752424.png" alt="1658810752424" style="zoom:80%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220610113151774.png" alt="image-20220610113151774" style="zoom: 67%;" />
...
- 不加注释的危害
  ...
  ![](./../../.vuepress/public/assets/images/java/java_overview.assets/新来的菜鸟程序员闯祸了。。。这段代码好多年都没人敢动过的.gif)
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310232527578.png" alt="image-20220310232527578" style="zoom:67%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/新华字典.jpg" alt="新华字典" style="zoom:28%;" />
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/JVM的跨平台性-1666858570703.jpg" alt="JVM的跨平台性" style="zoom:70%;" />

![image-20211217111217831](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20211217111217831.png)
...
<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220310165805739.png" alt="image-20220310165805739" style="zoom:67%;" />

#### 14.2.1 功能1：实现Java程序的跨平台性

我们编写的Java代码，都运行在**JVM** 之上。正是因为有了JVM，才使得Java程序具备了跨平台性。

<img src="./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220513191856727.png" alt="image-20220513191856727" style="zoom:50%;" />

使用JVM前后对比：

![image-20220514151716805](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220514151716805.png)
...
**案例1：个人信息输出**
 ...
 ![image-20220315221336038](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220315221336038.png)
...
![image-20220309004152219](./../../.vuepress/public/assets/images/java/java_overview.assets/image-20220309004152219-1646757896991.png) 
...
![img](./../../.vuepress/public/assets/images/java/java_overview.assets/image002.jpg)
